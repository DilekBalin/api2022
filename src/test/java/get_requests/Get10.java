...
public class Get10 extends GoRestBaseUrl {
    ...
    public void get01(){
        ...
        GoRestTestData dataKey = new GoRestTestData();//Gerekli methodun cagrilmasi icin obje olusturuyorum
        ...
        Map<String , Object> expectedData = dataKey.expectedDataMap(null,dataKeyMap);//ust Map'i olusturuyorum


        //3. Step: Send the request and Get the Response
        Response response = given().spec(spec).when().get("/{first}/{second}");

        Map<String, Object> actualDataMap = response.as(HashMap.class);//De-Serialization==> Json formatindan Java Obje'sine cevirdik
