    ...
    public void get01(){
        ...
        response.
                ...
                body("meta.pagination.limit",equalTo(10),
                        ...
                        "data.id", hasSize(10),//data icindeki id'ler 10 tane mi?
                        "data.status", hasItem("active"),//data icindeki status'de active diye bir item var mi?
                        "data.name", hasItems("Pranay Shukla, Chandraprabha Guneta PhD, Ms. Kumuda Reddy, Miss Geetanjali Gowda, Girija Varrier, Dhanadeepa Nair, Sudeva Pilla, Ritesh Jha Jr., Atmaja Saini, Baidehi Ahuja"));


        //Bayan ve erkek sayısını karşılaştıralım
        //1. Yol: Tüm cinisyetli çekip bayan sayısı ile karşılaştıralım.
        JsonPath json = response.jsonPath();  //JsonPath bize liste olarak verecegi icin kullandik
