...
public class Get09 extends HerOkuAppBaseUrl {
    ...
    public void get01(){
        ...
        assertEquals(bookingdatesMap.get("checkin"),((Map)actualDataMap.get("bookingdates")).get("checkin"));// Object'i Map ile narrowing yaptik ve .get dedikten sonra bir Map gibi davranacak
